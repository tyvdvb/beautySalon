		...
		<div className="pageContainer">
			...
			<div className="container">
				<div>
					<div className="text">
						...
						<p>Get in touch and we will be happy to speak with you.</p>
					</div>
				...
				<img
					src="https://i.pinimg.com/564x/d6/ef/fd/d6effdf00d49794f75b1a96151519f74.jpg"
					className="cardImg"
				/>
			</div>
			<hr className="horizontalLine" />
			<div className="containerMap">
				<div className="contactInfo">
					<h4>VISIT US</h4>
					<p>4201 30th St #100, San Diego, CA </p>
					<h4>PHONE</h4>
					<p>(619)-677-2078</p>
					<h4>EMAIL</h4>
